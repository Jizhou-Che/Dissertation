...
public class OWLAlignmentFormat {
    ...
    String logical_iri = "https://github.com/Jizhou-Che/Dissertation/Project/alignments.owl";
    ...
    protected void setOutput() throws Exception {
        managerMappingsOnto = OWLUtilities.createOWLOntologyManager();
    ...
    public void addClassMapping2Output(String iri1, String iri2, int direction, double conf) {
        ...
        } else if (direction == Utilities.L2R) {
            listAxioms2Add.add(new AddAxiom(
                    mappingsOnto,
                    createSubClassOfMapping(
                            ...
                            factory.getOWLClass(IRI.create(iri2)),
                            getAnnotations4Axiom(iri1, iri2, conf, "<"))));
        } else { //if (direction==Utilities.R2L){
            listAxioms2Add.add(new AddAxiom(
                    mappingsOnto,
    ...
    public void addDataPropMapping2Output(String iri1, String iri2, int direction, double conf) {
        if (direction == Utilities.EQ) {
            listAxioms2Add.add(new AddAxiom(
                    mappingsOnto,
    ...
    public void addObjPropMapping2Output(String iri1, String iri2, int direction, double conf) {
        if (direction == Utilities.EQ) {
            listAxioms2Add.add(new AddAxiom(
                    mappingsOnto,
